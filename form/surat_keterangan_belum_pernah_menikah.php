...
<html lang="en">
  <head>
    ...
    <title>Surat Keterangan Belum Pernah Kawin/Nikah</title>
  </head>
  <body>
    <div class="container">
  ...
  <div class="head">
    <img src="images/kop.png" align="center">
      ...
      <h2 class="alert-primary text-center mt-5">FORMULIR SURAT KETERANGAN BELUM PERNAH KAWIN/NIKAH</h2>
      ...
      <input type="number" name="id_form" value="2" hidden>
      ...
      <div class="form-group">
        ...
        <input type="file" class="form-control-file" name="content" value="content">
