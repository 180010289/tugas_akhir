...
<html lang="en">
  <head>
    ...
    <title>Surat Keterangan Pendirian Usaha</title>
  </head>
  <body>
    <div class="container">
...
<div class="head">
      ...
      <h2 class="alert-primary text-center mt-5">FORMULIR SURAT KETERANGAN PENDIRIAN USAHA</h2>
      <small><center><b>Isilah Data Formulir Berikut Sesuai Dengan Data Pada Kartu Keluarga Anda !</small></center></b>
      
      <form action="proses_sk_usaha.php" method="post">
        <input type="number" name="id_form" value="5" hidden>
   ...
   <div class="form-group">
    ...
    <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="form-group" name="jenis_usaha">
        <label>Jenis Usaha</label>
        <textarea class="form-control" name="jenis_usaha"></textarea>
      </div>

      <div class="form-group" name="guna_surat">
        <label>Surat ini dipergunakan untuk ?</label>
        <textarea class="form-control" name="guna_surat"></textarea>
      </div>
