...
<div class="head">
      ...
      <h2 class="alert-primary text-center mt-5">FORMULIR SURAT KETERANGAN MENINGGAL</h2>
      <small><center><b>Isilah Data Formulir Berikut Sesuai Dengan Data Pada Kartu Keluarga Anda !</small></center></b>
      
      <form action="proses_sk_meninggal.php" method="post">
        <input type="number" name="id_form" value="4" hidden>
    ...
    <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="form-group">
              ...
              <div class="form-group" name="meninggal_karena">
        <label>Meninggal Karena</label>
        <textarea class="form-control" name="meninggal_karena"></textarea>
      </div>
