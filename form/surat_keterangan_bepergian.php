...
<div class="head">
      ...
      <h2 class="alert-primary text-center mt-5">FORMULIR SURAT KETERANGAN BEPERGIAN</h2>
      <small><center><b>Isilah Data Formulir Berikut Sesuai Dengan Data Pada Kartu Keluarga Anda !</small></center></b>
      
      <form action="proses.php" method="post">
        <input type="number" name="id_form" value="10" hidden>
   ...
   <div class="form-group">
    ...
    <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="form-group" name="tujuan_bepergian">
        <label>Tujuan Bepergian</label>
        <textarea class="form-control" name="tujuan_bepergian"></textarea>
        </div>

      <div class="form-group" name="keperluan_bepergian">
        <label>Keperluan Bepergian</label>
        <textarea class="form-control" name="keperluan_bepergian"></textarea>
      </div>
        ...
        <div class="form-group" name="kendaraan">
              <label>Jenis Kendaraan</label>
              <textarea class="form-control" name="kendaraan"></textarea>
              </div>

      <div class="form-group" name="barang_bawaan">
              <label>Barang Bawaan</label>
              <textarea class="form-control" name="barang_bawaan"></textarea>
              </div>
      ...
      <div class="form-group" name="pengikut">
