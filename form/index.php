...
<html lang="en">
  <head>
  	<title>E-SURAT DESA BELIMBING</title>
    <meta charset="utf-8">
...
<img src="images/tbn.png" align="left" width="120" height="120">
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">WEBSITE RESMI E-SURAT DESA BELIMBING</h2>
				</div>
			</div>
			</div>
	...
	if(isset($_GET['pesan'])){
		if($_GET['pesan']=="gagal"){
			...
			echo "<div class=alert alert-danger role=alert>Username dan Password tidak sesuai !</div></b>";
		}
	}
	?>
			...
			<div class="row justify-content-center">
	            ...
	            <div class="form-group d-md-flex">
	            	<div class="w-50">
		            	<label class="checkbox-wrap checkbox-primary">Ingat Sandi
									  <input type="checkbox" checked>
									  <span class="checkmark"></span>
									</label>
								</div>
								<div class="w-50 text-md-right">
									<a href="#" style="color: #fff">Reset Sandi</a>
								</div>
	            </div>
				</div>
	          	</form>
