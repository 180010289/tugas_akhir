...
<div class="head">
      ...
      <h2 class="alert-primary text-center mt-5">FORMULIR SURAT KETERANGAN Kelahiran</h2>
      <small><center><b>Isilah Data Formulir Berikut Sesuai Dengan Data Pada Kartu Keluarga Anda !</small></center></b>
      
      <form action="proses.php" method="post">
        <input type="number" name="id_form" value="8" hidden>
    ...
    <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input type="text" name="nama_ayah" class="form-control" placeholder="Masukan Nama">
          </div> 

          <div class="form-group">
          <label>Nama Ibu</label>
          <input type="text" name="nama_ibu" class="form-control" placeholder="Masukan Nama">
          </div> 
