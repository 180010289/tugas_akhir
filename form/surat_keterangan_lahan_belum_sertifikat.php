...
<html lang="en">
  <head>
    ...
    <title>Surat Keterangan Kepemilikan Lahan Belum Bersertifikat</title>
  </head>
  <body>
    <div class="container">
...
<div class="head">
      ...
      <h2 class="alert-primary text-center mt-5">FORMULIR SURAT KETERANGAN KEPEMILIKAN LAHAN BELUM BERSERTIFIKAT</h2>
      <small><center><b>Isilah Data Formulir Berikut Sesuai Dengan Data Pada Kartu Keluarga Anda !</small></center></b>
      
      <form action="proses.php" method="post">
        <input type="number" name="id_form" value="7" hidden>
   ...
   <div class="form-group">
    ...
    <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="form-group" name="no_sppt">
        <label>Nomor SPPT (sesuaikan dengan bukti pajak)</label>
        <textarea class="form-control" name="no_sppt"></textarea>
      </div>

      <div class="form-group" name="untuk_kepengurusan">
        <label>Surat ini dipergunakan untuk ?</label>
        <textarea class="form-control" name="untuk_kepengurusan"></textarea>
      </div>
