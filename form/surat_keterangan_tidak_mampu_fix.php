...
<div class="head">
      ...
      <h2 class="alert-primary text-center mt-5">FORMULIR SURAT KETERANGAN KURANG MAMPU</h2>
      <small><center><b>Isilah Data Formulir Berikut Sesuai Dengan Data Pada Kartu Keluarga Anda !</small></center></b>
      
      <form action="proses_sk_kurang_mampu.php" method="post">
        <input type="number" name="id_form" value="1" hidden>
   ...
   <div class="form-group">
        ...
        <div class="form-group">
          <label><b>Kewarganegaraan</label></b>
    ...
    <div class="form-group">
      ...
      <div class="form-group" name="alamat">
        <label><b>Alamat</label></b>
        <textarea class="form-control" name="alamat"></textarea>
      </div>

      <div class="form-group">
        <label><b>Nomor Kartu Identitas (NIK)</label></b>
        <input type="number" name="nik" class="form-control" placeholder="Masukan NIK">
        </div>

        <div class="form-group mt-10">
          <label><b>Nama Anak</label></b>
          <input type="text" name="nama_anak" class="form-control" placeholder="Masukan Nama Anak">
          </div> 
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label><b>Tempat Lahir</label></b>
                <input type="text" name="tempat_lahir_anak" class="form-control" placeholder="Tempat Lahir Anak">
                </div>
            </div>
   ...
   <div class="form-group">
          <label><b>Agama</label></b>
          <select class="form-control" name="agama_anak">
            <option> - Pilih Agama</option>
            <option> Islam</option>
            <option> Hindu</option>
            <option> Kristen</option>
        ...
        <div class="form-group">
          <label><b>Kewarganegaraan</label></b>
          <select class="form-control" name="kewarganegaraan_anak">
            <option> - Pilih Kewarganegaraan</option>
            <option> Indonesia</option>
            <option> WNA</option>
          </select>
    ...
    <div class="form-group">
      ...
      <div class="form-group" name="alamat_anak">
        <label><b>Alamat</label></b>
      ...
      <div class="form-group">
        <label><b>Nomor Kartu Identitas (NIK)</label></b>
        <input type="number" name="nik_anak" class="form-control" placeholder="Masukan NIK Anak">
        </div>

        <div class="form-group">
          <label><b>Jumlah Saudara Kandung</label></b>
          <input type="number" name="jumlah_saudara" class="form-control" placeholder="Masukan Jumlah Saudara Kandung">
          </div> 

          <div class="form-group">
          <label><b>Status Anak</label></b>
